...
<br><br>
<div id="nav">您的位置：<a href="#">首页</a> >  我的购物车</div>
...
<div id="content">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="shopping">
        ...
        <tr id="<%=index%>">
            ...
            <td class="cart_td_6"><img src="img/shoppingCart/minus.jpg" alt="minus" onclick="changeNum('num_1','minus','<%=orderItems.get(i).getId()%>')" class="hand"/>
                <input type="text"  value="1" class="num_input" readonly="readonly"/> <img src="img/shoppingCart/adding.jpg" alt="add" onclick="changeNum('num_1','add','<%=orderItems.get(i).getId()%>')"  class="hand"/></td>
            <td class="cart_td_7"></td>
            <td class="cart_td_8">
                <a href="javascript:deleteRow('<%=i%>','<%=orderItems.get(i).getId()%>');"></a>
            </td>
        </tr>
        <%
                }
